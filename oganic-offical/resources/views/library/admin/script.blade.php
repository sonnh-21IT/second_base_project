...
<script src="{{ asset('public/assets/vendor/select2/select2.js') }}"></script>
<script src="{{ asset('public/assets/vendor/jquery-datatables/media/js/jquery.dataTables.js') }}"></script>
<script src="{{ asset('public/assets/vendor/jquery-datatables/extras/TableTools/js/dataTables.tableTools.min.js') }}"></script>
<script src="{{ asset('public/assets/vendor/jquery-datatables-bs3/assets/js/datatables.js') }}"></script>
...
<!-- Examples -->
<script src="{{ asset('public/assets/javascripts/tables/examples.datatables.default.js') }}"></script>
<script src="{{ asset('public/assets/javascripts/tables/examples.datatables.row.with.details.js') }}"></script>
<script src="{{ asset('public/assets/javascripts/tables/examples.datatables.tabletools.js') }}"></script>
