      ...
      <div class="modal-content">
         <form action="" method="post" class="form-horizontal form-bordered" id="form-edit">
            ...
            <div class="modal-header">
               ...
               <h4 class="modal-title d-3 col-6">Cấp Quyền Quản Trị<span id="category"></span></h4>
            </div>
            <div class="modal-body">
               <div class="form-group">
                  <label class="col-md-3 control-label" for="name">Người dùng</label>
                  <div class="col-md-6">
                     <input type="text" class="form-control" id="name_update" name="name" value="" disabled>
                  </div>
               </div>
               <div class="form-group">
                  <label class="col-md-3 control-label" for="">Vai trò</label>
