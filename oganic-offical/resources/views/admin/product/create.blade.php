               ...
               <div class="col-md-6">
                  <div class="form-group">
                     <div class="col">
                        ...
                        <textarea type="text" name="short_description" id="short-description" class="form-control summernote short-description"></textarea>
                     </div>
                  </div>
                  <div class="form-group">
                     <div class="col">
                        <label for="description">Mô Tả Chi Tiết</label>
                        <textarea type="text" name="description" id="description" class="form-control summernote description"></textarea>
                     </div>
                  </div>
               </div>
            </div>
